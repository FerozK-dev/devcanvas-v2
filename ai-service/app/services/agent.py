...
from app.schemas import Resume, ResumeGenerateResult
...
def generate_resume(resume_input: Resume) -> ResumeGenerateResult:
    """
    """

    question = f"Create a resume for the user with the following background {resume_input.model_dump_json(exclude=["job_description", "personal_info"])}."
