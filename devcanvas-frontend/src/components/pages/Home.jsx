    ...
    <section className="py-10 md:py-16">
      ...
      <div className="container max-w-screen-xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="font-normal text-gray-600 text-md md:text-xl mb-5">Are you a passionate web developer but don't have time to build a portfolio website? Let us help you!</p>
